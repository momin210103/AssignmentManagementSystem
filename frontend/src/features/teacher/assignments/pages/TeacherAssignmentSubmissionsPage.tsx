        ...
        <Card>
          <div className="flex min-h-[300px] flex-col items-center justify-center p-6 text-center">
            ...
            <p className="mt-1 text-sm text-text-secondary">
              Something went wrong while loading student submissions.
            </p>
          </div>
        </Card>
      </div>
    ...
    "
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        ...
        <Card className="col-span-2 p-4 sm:col-span-1 sm:p-5">
          ...
          <p className="mt-1 text-2xl font-bold text-warning sm:text-3xl">
            {
              submissions.filter(
                (submission) => submission.status !== "Reviewed",
              ).length
          ...
          <table className="w-full">
            ...
            <tbody>
              {submissions.map((submission, index) => (
                <tr
                  key={submission.id}
                  className="border-b border-border last:border-b-0 transition hover:bg-background/70"
                >
